...
namespace api.oems.Migrations
{
    ...
    [Migration("20190724064730_Add_Medium_Class_Subject")]
    partial class Add_Medium_Class_Subject
    {
            ...
            modelBuilder.Entity("api.oems.Core.Models.Tutor.ClassInMedium", b =>
                {
                    ...
                    b.Property<int?>("TutorMediumId");

                    b.HasKey("Id");

                    b.HasIndex("TutorClassId");

                    b.HasIndex("TutorMediumId");
